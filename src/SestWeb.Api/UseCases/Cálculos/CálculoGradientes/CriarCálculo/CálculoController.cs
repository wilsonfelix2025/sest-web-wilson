...
{
    [Route("api/criar-calculo-gradientes")]
    [ApiController]
    public class CálculoController : ControllerBase
    {
        private readonly ICriarCálculoGradientesUseCase _useCase;
        private readonly Presenter _presenter;

        public CálculoController(ICriarCálculoGradientesUseCase useCase, Presenter presenter)
        {
            _useCase = useCase;
        ...
        public async Task<IActionResult> CriarCálculo(CriarCálculoGradientesRequest request)
        {
        ...
        private CriarCálculoGradientesInput PreencherInput(CriarCálculoGradientesRequest request)
        {
            var input = new CriarCálculoGradientesInput
            {
