...
{
    public class RegistrarUsuarioValidation : AbstractValidator<RegistrarUsuarioRequest>
    {
        ...
        {
            RuleFor(m => m.Nome).NotEmpty().MaximumLength(15).MinimumLength(3);
            RuleFor(m => m.Sobrenome).NotEmpty().MaximumLength(15).MinimumLength(3);
