...
{
    internal class EditarFiltroMediaMovelUseCase : IEditarFiltroMediaMovelUseCase
    {
        ...
        public EditarFiltroMediaMovelUseCase(IPerfilReadOnlyRepository perfilReadOnlyRepository, IPoçoWriteOnlyRepository poçoWriteOnlyRepository
            , IPoçoReadOnlyRepository poçoReadOnlyRepository, IFiltroMédiaMóvelFactory filtroMédiaMóvelFactory, IPipelineUseCase pipelineUseCase)
        {
        ...
        public async Task<EditarFiltroOutput> Execute(EditarFiltroMediaMovelInput input)
        {
            try
            {
                ...
                var result = _filtroMédiaMóvelFactory.CreateFiltroMédiaMóvel(input.Nome, "FiltroMédiaMóvel", perfilEntrada, perfilSaída, poço.Trajetória, null,
