...
{
    internal class EditarFiltroLinhaBaseFolhelhoUseCase : IEditarFiltroLinhaBaseFolhelhoUseCase
    {
        ...
        public EditarFiltroLinhaBaseFolhelhoUseCase(IPerfilReadOnlyRepository perfilReadOnlyRepository, IPoçoWriteOnlyRepository poçoWriteOnlyRepository
            , IPoçoReadOnlyRepository poçoReadOnlyRepository, IFiltroLinhaBaseFolhelhoFactory filtroLinhaBaseFolhelhoFactory, IPipelineUseCase pipelineUseCase)
        {
        ...
        public async Task<EditarFiltroOutput> Execute(EditarFiltroLinhaBaseFolhelhoInput input)
        {
            try
            {
                ...
                var result = _filtroLinhaBaseFolhelhoFactory.CreateFiltroLinhaBaseFolhelho(input.Nome, "FiltroLinhaBaseFolhelho", perfilEntrada, perfilSaída, poço.Trajetória, null,
