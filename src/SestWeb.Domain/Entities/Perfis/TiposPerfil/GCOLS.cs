...
{
    public class GCOLS : PerfilBase, IPerfilDerived
    {
        static GCOLS()
        {
            PerfisFactory<GCOLS>.Register((nome, conversorProfundidade, litologia) => new GCOLS(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private GCOLS(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
            EstiloVisual = new EstiloVisual("#c044c0", 1.0, EstiloLinha.Solid, TipoMarcador.Nenhum, "Transparent");
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<GCOLS>();

        public static readonly string _descrição = "Gradiente de Colapso Superior";
        ...
        public override GrupoPerfis GrupoPerfis { get; private protected set; } = GrupoPerfis.Gradientes;
