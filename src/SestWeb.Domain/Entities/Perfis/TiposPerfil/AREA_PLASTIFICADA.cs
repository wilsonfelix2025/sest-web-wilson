...
{
    public class AREA_PLASTIFICADA : PerfilBase, IPerfilDerived
    {
        static AREA_PLASTIFICADA()
        {
            PerfisFactory<AREA_PLASTIFICADA>.Register((nome, conversorProfundidade, litologia) => new AREA_PLASTIFICADA(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private AREA_PLASTIFICADA(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<AREA_PLASTIFICADA>();
