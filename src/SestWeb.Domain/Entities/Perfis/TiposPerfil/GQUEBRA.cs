...
{
    public class GQUEBRA : PerfilBase, IPerfilDerived
    {
        static GQUEBRA()
        {
            PerfisFactory<GQUEBRA>.Register((nome, conversorProfundidade, litologia) => new GQUEBRA(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private GQUEBRA(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<GQUEBRA>();

        public static readonly string _descrição = "Gradiente de Quebra";
