...
{
    public class GTHORmax : PerfilBase, IPerfilDerived
    {
        static GTHORmax()
        {
            PerfisFactory<GTHORmax>.Register((nome, conversorProfundidade, litologia) => new GTHORmax(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private GTHORmax(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        ...
        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<GTHORmax>();

        public static readonly string _descrição = "Gradiente da Tensão Horizontal Maior";
