...
{
    public class K0 : PerfilBase, IPerfilDerived
    {
        static K0()
        {
            PerfisFactory<K0>.Register((nome, conversorProfundidade, litologia) => new K0(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private K0(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<K0>();

        public static readonly string _descrição = "K0";
