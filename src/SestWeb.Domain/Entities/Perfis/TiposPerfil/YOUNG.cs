...
{
    public class YOUNG : PerfilBase, IPerfilDerived
    {
        static YOUNG()
        {
            PerfisFactory<YOUNG>.Register((nome, conversorProfundidade, litologia) => new YOUNG(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private YOUNG(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<YOUNG>();

        public static readonly string _descrição = "Módulo de Young";
