...
{
    public class PCOLI: PerfilBase, IPerfilDerived
    {
        static PCOLI()
        {
            PerfisFactory<PCOLI>.Register((nome, conversorProfundidade, litologia) => new PCOLI(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private PCOLI(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<PCOLI>();

        public static readonly string _descrição = "Pressão de Colapso Inferior";
