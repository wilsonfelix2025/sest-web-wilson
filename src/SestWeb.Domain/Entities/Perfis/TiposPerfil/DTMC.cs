...
{
    public class DTMC : PerfilBase, IPerfilDerived
    {
        static DTMC()
        {
            PerfisFactory<DTMC>.Register((nome, conversorProfundidade, litologia) => new DTMC(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private DTMC(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<DTMC>();

        public static readonly string _descrição = "Tempo de Trânsito Compressional da Matriz";
