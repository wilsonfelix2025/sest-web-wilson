...
{
    public class KS : PerfilBase, IPerfilDerived
    {
        static KS()
        {
            PerfisFactory<KS>.Register((nome, conversorProfundidade, litologia) => new KS(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private KS(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<KS>();

        public static readonly string _descrição = "Módulo de Compressibilidade dos Grãos";
