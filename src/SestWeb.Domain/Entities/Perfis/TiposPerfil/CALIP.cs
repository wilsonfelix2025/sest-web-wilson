...
{
    public class CALIP : PerfilBase, IPerfilDerived
    {
        static CALIP()
        {
            PerfisFactory<CALIP>.Register((nome, conversorProfundidade, litologia) => new CALIP(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private CALIP(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<CALIP>();

        public static readonly string _descrição = "Caliper";
