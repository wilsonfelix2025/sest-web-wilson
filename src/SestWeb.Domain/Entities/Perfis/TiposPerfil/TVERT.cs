...
{
    public class TVERT : PerfilBase, IPerfilDerived
    {
        static TVERT()
        {
            PerfisFactory<TVERT>.Register((nome, conversorProfundidade, litologia) => new TVERT(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private TVERT(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<TVERT>();

        public static readonly string _descrição = "Tensão Vertical";
