...
{
    public class GLAMA : PerfilBase, IPerfilDerived
    {
        static GLAMA()
        {
            PerfisFactory<GLAMA>.Register((nome, conversorProfundidade, litologia) => new GLAMA(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private GLAMA(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
            EstiloVisual = new EstiloVisual("#70370c", 1.0, EstiloLinha.Solid, TipoMarcador.Nenhum, "Transparent");
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<GLAMA>();

        public static readonly string _descrição = "Peso de Lama";
