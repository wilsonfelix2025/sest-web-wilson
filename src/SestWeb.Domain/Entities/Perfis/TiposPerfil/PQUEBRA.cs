...
{
    public class PQUEBRA : PerfilBase, IPerfilDerived
    {
        static PQUEBRA()
        {
            PerfisFactory<PQUEBRA>.Register((nome, conversorProfundidade, litologia) => new PQUEBRA(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private PQUEBRA(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<PQUEBRA>();

        public static readonly string _descrição = "Pressão de Quebra";
