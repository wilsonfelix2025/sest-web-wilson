...
{
    public class DTMS : PerfilBase, IPerfilDerived
    {
        static DTMS()
        {
            PerfisFactory<DTMS>.Register((nome, conversorProfundidade, litologia) => new DTMS(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private DTMS(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<DTMS>();

        public static readonly string _descrição = "Tempo de Trânsito Cisalhante da Matriz";
