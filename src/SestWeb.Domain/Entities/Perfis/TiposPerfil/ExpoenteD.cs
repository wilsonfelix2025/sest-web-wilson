...
{
    public class ExpoenteD : PerfilBase, IPerfilDerived
    {
        static ExpoenteD()
        {
            PerfisFactory<ExpoenteD>.Register((nome, conversorProfundidade, litologia) => new ExpoenteD(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private ExpoenteD(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<ExpoenteD>();

        public static readonly string _descrição = "Expoente D";
