...
{
    public class RHOG : PerfilBase, IPerfilDerived
    {
        static RHOG()
        {
            PerfisFactory<RHOG>.Register((nome, conversorProfundidade, litologia) => new RHOG(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private RHOG(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<RHOG>();

        public static readonly string _descrição = "Densidade dos Grãos";
