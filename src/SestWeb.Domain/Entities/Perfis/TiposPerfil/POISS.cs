...
{
    public class POISS : PerfilBase, IPerfilDerived
    {
        static POISS()
        {
            PerfisFactory<POISS>.Register((nome, conversorProfundidade, litologia) => new POISS(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private POISS(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<POISS>();

        public static readonly string _descrição = "Coeficiente de Poisson";
