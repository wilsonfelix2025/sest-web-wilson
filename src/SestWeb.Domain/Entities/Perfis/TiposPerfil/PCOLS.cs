...
{
    public class PCOLS : PerfilBase, IPerfilDerived
    {
        static PCOLS()
        {
            PerfisFactory<PCOLS>.Register((nome, conversorProfundidade, litologia) => new PCOLS(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private PCOLS(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<PCOLS>();

        public static readonly string _descrição = "Pressão de Colapso Superior";
