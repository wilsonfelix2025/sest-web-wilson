...
{
    public class GFRAT : PerfilBase, IPerfilDerived
    {
        static GFRAT()
        {
            PerfisFactory<GFRAT>.Register((nome, conversorProfundidade, litologia) => new GFRAT(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private GFRAT(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
            EstiloVisual = new EstiloVisual("#424242", 1.0, EstiloLinha.Solid, TipoMarcador.Nenhum, "Transparent");
        }

        #region Fields

        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<GFRAT>();

        public static readonly string _descrição = "Gradiente de Fratura";
