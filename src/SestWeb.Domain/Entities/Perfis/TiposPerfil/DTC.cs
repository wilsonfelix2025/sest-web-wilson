...
{
    public class DTC : PerfilBase, IPerfilDerived
    {
        static DTC()
        {
            PerfisFactory<DTC>.Register((nome, conversorProfundidade, litologia) => new DTC(nome, conversorProfundidade, litologia));
        ...
        [BsonConstructor]
        private DTC(string nome, IConversorProfundidade conversorProfundidade, ILitologia litologia) : base(nome, conversorProfundidade, litologia)
        {
        ...
        public static readonly TipoPerfil _tipoPerfil = Base.TiposPerfil.GeTipoPerfil<DTC>();

        public static readonly string _descrição = "Tempo de Trânsito Compressional";
