...
{
    /// <summary>
    /// Validar aqui propriedades que permitam criar CálculoGradientes em segurança.
    /// </summary>
    public class CálculoGradientesEmCriaçãoValidator : CálculoEmCriaçãoValidator<CálculoGradientesEmCriação>, ICálculoGradientesEmCriaçãoValidator
    {
        public CálculoGradientesEmCriaçãoValidator()
        {
